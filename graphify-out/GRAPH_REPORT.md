# Graph Report - wave-defense-td  (2026-06-03)

## Corpus Check
- 62 files · ~1,410,537 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 579 nodes · 502 edges · 87 communities (65 shown, 22 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `58a5ad90`
...
Cohesion: 0.12
Nodes (16): code:gdscript (extends Node), code:gdscript (extends StaticBody2D), code:bash (git add res/scripts/global_events.gd res/scripts/nexus.gd re), code:gdscript (extends Node2D), code:bash (git add res/scripts/flow_field_manager.gd), code:gdscript (extends MultiMeshInstance2D), code:bash (git add res/scripts/enemy_manager.gd), code:gdscript (extends Sprite2D) (+8 more)

### Community 82 - "Community 82"
Cohesion: 0.18
Nodes (10): code:gdscript (extends Node), code:bash (git add project.godot scripts/global_events.gd), code:gdscript (extends StaticBody2D), code:bash (git add scripts/nexus.gd), code:bash (git add prefabs/nexus.tscn), Global Events & Nexus Implementation Plan, Task 1: Create GlobalEvents Autoload, Task 2: Create Nexus Script (+2 more)
...
## Knowledge Gaps
- **291 isolated node(s):** `contextManagement`, `generalistProfile`, `autoMemory`, `useOSC52Copy`, `useOSC52Paste` (+286 more)
